...
from application.ports import EvaluationDataset, EvaluationReport, RAGPipelinePort


class AuditApplicationService:
    """Use-case service for ingestion sync and audit execution."""
...
class EvaluationApplicationService:
    """Use-case service for benchmark execution and metric aggregation."""
